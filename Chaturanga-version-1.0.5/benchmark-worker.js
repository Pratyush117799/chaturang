...
/**
 * Chaturanga v1.0.5 — Benchmark Web Worker
 * Handles heavy bot simulations on a background thread.
 * v1.0.5: Batch mode — process multiple games per message to reduce IPC overhead.
 */

// Import required engine and bot scripts
// Paths are relative to the worker location within "Chaturanga-version-1.0.5"
