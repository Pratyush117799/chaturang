...
(function () {
  ...
  function centerBonus(sq) {
    ...
    const r = Number.parseInt(sq[1], 10) - 1;          // rank  0-7
  ...
  function scoreMoveTablet(game, move, opponentThreats) {
    ...
    if (piece.type === 'king') {
      ...
      const r       = Number.parseInt(move.to[1], 10) - 1;
  ...
  // Public API
  // ══════════════════════════════════════════════════════════════════════════
  globalThis.ChaturangaTieredBot = {
    /**
    ...
    getMove(game, eloLevel) {
      ...
      switch (eloLevel) {
        ...
        case 100:
        default:
          const randomBot = globalThis.ChaturangaRandomBot;
          return randomBot
