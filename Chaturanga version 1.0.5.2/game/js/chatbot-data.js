...
globalThis.ChaturangaChatbot = (function () {
  ...
  const RULES = [
    ...
    {
      match: /krauncha.*vyuha|krauncha.*formation|heron.*formation/i,
      reply: `The Krauncha Vyuha (Heron Formation) is the Pandava offensive answer to the Garuda. A long narrow neck of Rathas drives forward while spreading cavalry wings flank wide. Drupada leads the beak, Bhima and Dhristadhyumna form both wings. Highly aggressive — intended to drive fear through the enemy formation. Natural counter: Garuda Vyuha.`
    },
    {
      match: /shakata.*vyuha|shakata.*formation|cart.*formation|box.*formation/i,
      reply: `The Shakata Vyuha (Cart/Box Formation) was Drona's compact defensive rectangle on Day 11 — Rathas at the front wall, Raja buried at rear centre. Like a bullock cart, narrow and impenetrable frontally. Arjuna pierced it with the Krauncha's narrow beak. Our Kurukshetra Day 11 scenario "Drona Commands" recreates this exact challenge.`
    },
    {
      match: /vajra.*vyuha|vajra.*formation|diamond.*formation|thunderbolt.*formation/i,
      reply: `The Vajra Vyuha (Diamond/Thunderbolt Formation) is one of the most frequently used Pandava formations — Days 1, 7, and against the Lotus on Day 15. Maharathis guard the diamond centre, infantry surrounds all sides. The tip is a piercing weapon; the wide rear gives stability. Counter: Mandala Vyuha — the circular galaxy absorbs the diamond point without exposing a flank.`
    },
    {
      match: /padma.*vyuha|padma.*formation|lotus.*formation/i,
      reply: `The Padma Vyuha (Blooming Lotus Formation) was Drona's Day 15 formation — even harder than the Chakravyuha because its petals spiral organically and unpredictably. Our Kurukshetra Day 12 scenario "The Lotus Closes" is based on this formation. Counter: simultaneous attacks on all petals simultaneously — practically impossible.`
    },
    {
      match: /mandala.*vyuha|mandala.*formation|circle.*formation|galaxy.*formation/i,
      reply: `The Mandala Vyuha (Galaxy/Circle Formation) was Bhishma's defensive masterpiece on Day 7 — no clear front or rear, very hard to penetrate from any angle. Commander at the centre, Maharathis at equal radial distance. Counter: Vajra Vyuha — the thunderbolt strikes between the galaxy's sectors.`
    },
    {
      match: /trishula.*vyuha|trishula.*formation|trident.*formation/i,
      reply: `The Trishula Vyuha (Trident Formation) was Arjuna's answer to Bhishma's Kurma on Day 8. Three Ratha-tipped prongs penetrate simultaneously — each targeting one of the tortoise's four limb gaps. The tortoise cannot defend three directions at once. Counter: Kurma itself — the shell absorbs each prong.`
    },
    {
      match: /ardha.*chandra|crescent.*formation|half.*moon.*formation/i,
      reply: `The Ardha Chandra Vyuha (Half Crescent Formation) was one of Arjuna's most-used formations — Days 3, 12, and 16. Bhima commands the right tip, Abhimanyu the left. The tips act as pincers closing inward while Yudhisthira sits safely at the rear centre. Counter: Sringataka (Twin-Horn) — both horn tips meet the crescent points before the pincers can close.`
    },
    {
      match: /makara.*vyuha|makara.*formation|crocodile.*formation/i,
      reply: `The Makara Vyuha (Crocodile Formation) — used by Bhishma on Day 5, later by Karna on Day 16. Wide jaw of Elephants at the front, designed to crush between jaws, then coil the tail to trap the enemy. Counter: Shyen (Hawk) Vyuha — a fast predatory strike before the jaws can close.`
    },
    {
      match: /sringataka.*vyuha|sringataka.*formation|twin.*horn|pincer.*formation/i,
      reply: `The Sringataka Vyuha (Twin-Horn/Pincer Formation) — Arjuna on Days 3 and 12 — two forward-pointing horns separated by a pawn wall. When the enemy charges the centre, the horns curl inward like a bull snaring prey. Counter: Ardha Chandra — the crescent tips meet the horn bases before the pincer can close.`
    },
    {
      match: /shyen.*vyuha|shyen.*formation|hawk.*formation|falcon.*formation/i,
      reply: `The Shyen Vyuha (Hawk/Falcon Formation) — Drona's Day 4 faster, more aggressive variant of Garuda. More compact, steeper wing angle, hooked talons at both wing tips. The hawk dives; it does not circle. Counter: Garuda — the eagle spreads wider to catch the diving hawk's flanks.`
    },
    {
      match: /sarvatobhadra.*vyuha|sarvatobhadra.*formation|safe.*from.*all.*sides/i,
      reply: `The Sarvatobhadra Vyuha (Safe-from-all-Sides Formation) — Bhishma's Day 9 omnidirectional formation. Six Maharathis radiate from the commander like a six-pointed star, every direction guarded. Counter: Nakshatra Mandala — eight constellation clusters surround and isolate each ray.`
    },
    {
      match: /nakshatra.*mandala|nakshatra.*formation|constellation.*formation/i,
      reply: `The Nakshatra Mandala (Constellation Wheel) — Arjuna's Day 9 answer to Bhishma's Sarvatobhadra. Eight concentrated star-cluster nodes in a wheel, linked by Elephant connectors. Unlike Mandala's smooth ring, Nakshatra has concentrated nodes overwhelming the six Sarvatobhadra rays with eight coordinated attacks.`
    },
    {
      match: /suchi.*vyuha|suchimukha|needle.*formation/i,
      reply: `The Suchimukha Vyuha (Needle Formation) was the ultra-narrow piercing tip of Drona's triple Chakrashakata on Day 14. Karna and Ashwatthama at the tip, Jayadratha at the very end. One point penetrates any formation. Counter: spread wide to dilute the tip before it penetrates.`
    },
    {
      match: /chakrashakata.*vyuha|chakrashakata.*formation|drona.*triple|triple.*vyuha/i,
      reply: `The Chakrashakata Vyuha was Drona's greatest tactical invention on Day 14. Three formations simultaneously: Suchimukha needle through the centre, two mini Chakra wheels grinding the flanks, Shakata box at the rear. Countering any one formation exposes you to the other two. Only Arjuna + Krishna could have countered it — which is why Drona arranged for Arjuna to be lured away south.`
    },
    {
      match: /asura.*vyuha|asura.*formation|demon.*formation/i,
      reply: `The Asura Vyuha (Demon/Wall Formation) — Kauravas on Day 10. Pure brute force: all heaviest pieces forward in an unbroken wall. No elegance, pure power. Counter: Deva Vyuha — six fast targeted strike columns isolate sections of the wall and pick off commanders.`
    },
    {
      match: /deva.*vyuha|deva.*formation|divine.*formation/i,
      reply: `The Deva Vyuha (Divine/Light-Ray Formation) — Arjuna's Day 10 targeted answer to the Asura wall. Six independent fast strike columns from a unified bridge base, empty lanes for rapid manoeuvre. It succeeded — isolated Bhishma specifically and led to his fall.`
    },
    {
      match: /oormi.*vyuha|oormi.*formation|wave.*formation|ocean.*formation/i,
      reply: `The Oormi Vyuha (Ocean Wave Formation) — Bhishma's constantly-reforming afternoon-of-Day-8 formation. Three rolling wave fronts on either side, Rathas at each crest, continuously reforming. No position exposed for long. Counter: Sringataka (Horned) — ride over the crests at their peaks.`
    },
    {
      match: /danda.*vyuha|danda.*formation|rod.*formation|sarvatomukhi/i,
      reply: `The Sarvatomukhi Danda Vyuha (All-Facing Rod) — Bhishma's opening-day formation on Day 1. A circular head of six Maharathis faces all directions while a long rear Danda resupplies continuously. Counter: cut the Danda — isolate the head from its supply line.`
    },
    {
      match: /mala.*vyuha|mala.*formation|garland.*formation|chain.*formation/i,
      reply: `The Mala Vyuha (Garland/Chain Formation) — Bhishma's Day 6 defensive response after heavy losses. Maharathis connected by Pawn chain links, outer garland wrapping the army. No gap means no part can be cut off. Counter: Vajra — the diamond tip penetrates between ring segments before the chain reforms.`
    },
    {
      match: /gomutrika.*vyuha|gomutrika.*formation|zigzag.*formation/i,
      reply: `The Gomutrika Vyuha (Zigzag/Cow-Path Formation) — Pandavas on Day 7. Two interleaved V-bands cover different diagonal attack angles simultaneously. No single clear front. Counter: Mandala — the circular formation has no front to face and absorbs both diagonals equally.`
    },
    {
      match: /vyaghra.*vyuha|vyaghra.*formation|tiger.*formation/i,
      reply: `The Vyaghra Vyuha (Tiger Formation) — Drona's Day 11 mass-power formation. Wide Ratha jaw at the front, Elephant flanks, wide body deliberately expanding outward. The tiger does not dodge — it overwhelms. Specifically designed to absorb Arjuna's Trishula in its jaw. Counter: target the jaw joints where the Rathas sit.`
    },
    {
      match: /shringhataka.*formation|crossroads.*formation|four.*road.*formation/i,
      reply: `The Shringhataka Vyuha (Four-Road/Crossroads) — Bhishma's Day 5 omnidirectional response. The army forms a perfect plus-sign in all four cardinal directions — every direction can engage independently. Counter: Garuda — the eagle wingspan stretches between two adjacent crossroads arms and pinches them together.`
    },
